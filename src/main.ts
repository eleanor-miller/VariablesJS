...
`;
var numberOfCupsOfCoffee: number = 2;
...
console.log(
  `${eleanor.fullName} drinks ${numberOfCupsOfCoffee} cups of coffee every day!`
);
console.log(`${eleanor.fullName} likes the number ${eleanor.luckyNumber}!`);
